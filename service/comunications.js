...
const communicationsSid = process.env.COMMUNICATIONS_SID;
const communicationsAPI = process.env.COMMUNICATIONS_API;
...
const sendSms = async (phoneNo, body) => {
    ...
    const url = `${ communicationsAPI }/${ communicationsSid }/messages`;
    const options = {
        method: "post",
        headers: {
